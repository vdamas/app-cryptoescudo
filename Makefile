...
# Cryptoescudo
DEFINES   += BIP44_COIN_TYPE=111 BIP44_COIN_TYPE_2=111 COIN_P2PKH_VERSION=28 COIN_P2SH_VERSION=22 COIN_FAMILY=1 COIN_COINID=\"CryptoEscudo\" COIN_COINID_HEADER=\"CRYPTOESCUDO\" COIN_COLOR_HDR=0x65D196 COIN_COLOR_DB=0xB2E8CB COIN_COINID_NAME=\"CryptoEscudo\" COIN_COINID_SHORT=\"CESC\" COIN_KIND=COIN_KIND_CRYPTOESCUDO
...
listvariants:
	@echo VARIANTS COIN bitcoin_legacy bitcoin_cash bitcoin_gold litecoin dogecoin cryptoescudo dash horizen komodo stratis peercoin pivx viacoin vertcoin stealth digibyte qtum bitcoin_private firo gamecredits zclassic xsn nix lbry ravencoin resistance hydra hydra_testnet xrhodium

else

listvariants:
	@echo VARIANTS COIN bitcoin_legacy bitcoin_cash bitcoin_gold litecoin dogecoin cryptoescudo dash horizen komodo stratis peercoin pivx viacoin vertcoin stealth digibyte qtum bitcoin_private firo gamecredits zclassic xsn nix lbry ravencoin hydra hydra_testnet xrhodium
